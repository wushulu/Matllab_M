###########################################################################
## Makefile generated for component 'Testerr'. 
## 
## Makefile     : Testerr.mk
## Generated on : Sat Oct 12 15:25:19 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Testerr.elf
...
COMPILER_COMMAND_FILE     = Testerr_comp.rsp
CMD_FILE                  = Testerr.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Testerr.elf
...
DEFINES_STANDARD = -DMODEL=Testerr -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Work\Matlab\PMSM\testgeneration\Testbuilderror\STM32CubeIDE\STM32F401RETX_FLASH.ld"
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Work\Matlab\PMSM\testgeneration\Testbuilderror\STM32CubeIDE\STM32F401RETX_FLASH.ld"
...
CPP_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Work\Matlab\PMSM\testgeneration\Testbuilderror\STM32CubeIDE\STM32F401RETX_FLASH.ld"
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Work\Matlab\PMSM\testgeneration\Testbuilderror\STM32CubeIDE\STM32F401RETX_FLASH.ld"
...
%.o : $(START_DIR)/Testerr_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Testerr_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Testerr_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Testerr_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Testerr_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Testerr.o : $(START_DIR)/Testerr_ert_rtw/Testerr.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Testerr_data.o : $(START_DIR)/Testerr_ert_rtw/Testerr_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Testerr_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Testerr_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
