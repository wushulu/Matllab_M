...
void MX_LPUART1_UART_Init(void)
{
  ...
  */
  ...
  LPUART_InitStruct.BaudRate = 1400000;
...
void MX_TIM3_Init(void)
{
  ...
  */
  ...
  /* TIM3_CH3 Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_CHANNEL_5, LL_DMAMUX_REQ_TIM3_CH3);
  ...
  /* TIM3_CH4 Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_CHANNEL_4, LL_DMAMUX_REQ_TIM3_CH4);
