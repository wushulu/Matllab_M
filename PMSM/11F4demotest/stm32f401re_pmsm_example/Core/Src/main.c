...
void MX_ADC1_Init(void)
{
  ...
  PB1   ------> ADC1_IN9
  */
  GPIO_InitStruct.Pin = CURRENT_FDBK3_PhC_Pin|CURRENT_FDBK2_PhB_Pin|TEMPERATURE_FDBK_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = CURRENT_FDBK1_PhA_Pin|VBUS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  ...
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(SPEED_GPIO_Port, &GPIO_InitStruct);
...
void MX_USART2_UART_Init(void)
{
  ...
  */
  ...
  USART_InitStruct.BaudRate = 1400000;
...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOC, LL_GPIO_PIN_7|UH_EN1_Pin|VH_EN2_Pin|WH_EN3_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_7|UH_EN1_Pin|VH_EN2_Pin|WH_EN3_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
