###########################################################################
## Makefile generated for component 'HallcorrectionFimal'. 
## 
## Makefile     : HallcorrectionFimal.mk
## Generated on : Fri Oct 18 17:20:00 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/HallcorrectionFimal.elf
...
PRODUCT_NAME              = HallcorrectionFimal
MAKEFILE                  = HallcorrectionFimal.mk
MATLAB_ROOT               = D:/software/MATLAB2024a
MATLAB_BIN                = D:/software/MATLAB2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/Work/Matlab/PMSM/07Hallcorrection
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = HallcorrectionFimal_comp.rsp
CMD_FILE                  = HallcorrectionFimal.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/HallcorrectionFimal.elf
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DINTERNAL_XCP_MEM_BLOCK_1_SIZE=160 -DINTERNAL_XCP_MEM_BLOCK_1_NUMBER=1 -DINTERNAL_XCP_MEM_BLOCK_2_SIZE=168 -DINTERNAL_XCP_MEM_BLOCK_2_NUMBER=5 -DINTERNAL_XCP_MEM_BLOCK_3_SIZE=24 -DINTERNAL_XCP_MEM_BLOCK_3_NUMBER=5 -DINTERNAL_XCP_MEM_RESERVED_POOLS_TOTAL_SIZE=1456 -DINTERNAL_XCP_MEM_RESERVED_POOLS_NUMBER=6 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=2 -DXCP_MIN_EVENT_NO_RESERVED_POOL=6 -DXCP_MAX_CTO_SIZE=255 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=2048 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0
DEFINES_SKIPFORSIL = -DHWI_ADC_IRQ -DMW_SCHEDULER_PRIORITY=3 -DXCP_CUSTOM_PLATFORM -D__FPU_PRESENT=1U -D__FPU_USED=1U -DEXTMODE_DISABLE_ARGS_PROCESSING -DSTACK_SIZE=64 -DRT -DHWI_EXTI9_5_IRQHandler -DHWI_ADC_IRQHandler
DEFINES_STANDARD = -DMODEL=HallcorrectionFimal -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Work\Matlab\PMSM\07Hallcorrection\Testbuilderror\STM32CubeIDE\STM32F401RETX_FLASH.ld"
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Work\Matlab\PMSM\07Hallcorrection\Testbuilderror\STM32CubeIDE\STM32F401RETX_FLASH.ld"
...
CPP_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Work\Matlab\PMSM\07Hallcorrection\Testbuilderror\STM32CubeIDE\STM32F401RETX_FLASH.ld"
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Work\Matlab\PMSM\07Hallcorrection\Testbuilderror\STM32CubeIDE\STM32F401RETX_FLASH.ld"
...
%.o : $(START_DIR)/HallcorrectionFimal_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/HallcorrectionFimal_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/HallcorrectionFimal_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/HallcorrectionFimal_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/HallcorrectionFimal_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
HallcorrectionFimal.o : $(START_DIR)/HallcorrectionFimal_ert_rtw/HallcorrectionFimal.c
	$(CC) $(CFLAGS) -o "$@" "$<"


HallcorrectionFimal_data.o : $(START_DIR)/HallcorrectionFimal_ert_rtw/HallcorrectionFimal_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/HallcorrectionFimal_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/HallcorrectionFimal_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
