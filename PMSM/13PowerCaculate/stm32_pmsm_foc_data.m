...
pmsm.model    = 'Anaheim-BLY172S-310-4000';%    // Manufacturer Model Number
pmsm.sn       = '0004';              %           // Manufacturer Model Number
pmsm.p        = 4;                  %           // Pole Pairs for the motor
pmsm.Rs       = 18.1;                %Ohm        // Stator Resistor
pmsm.Ld       = 40e-3;             %H          // D-axis inductance value
pmsm.Lq       = 40e-3;             %H          // Q-axis inductance value
pmsm.J        = 4.8018552467e-06;   %Kg-m2      // Inertia in SI units
pmsm.B        = 9.6037104933e-06;   %Kg-m2/s    // Friction Co-efficient
pmsm.Ke       = 26;                  %Bemf Const	// Vpk_LL/krpm
...
inverter.V_dc          = 110;       				%V      // DC Link Voltage of the Inverter (Required for motor)
inverter.I_trip        = 3.55;       			%Amps   // Max current for trip
inverter.Rds_on        = 1;     				%Ohms   // Rds ON for X-NUCLEO-IHM07M1 (From motor driver chip)
inverter.Rshunt        = 0.15;    				%Ohms   // Rshunt for X-NUCLEO-IHM07M1
...
inverter.ISenseVoltPerAmp = 0.75; 				%V/Amps // Current sense voltage output per 1 A current (Rshunt * iSense op-amp gain)
