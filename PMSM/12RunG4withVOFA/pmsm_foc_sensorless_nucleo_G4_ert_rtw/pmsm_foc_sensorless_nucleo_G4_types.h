/*
 * File: pmsm_foc_sensorless_nucleo_G4_types.h
 *
...
#ifndef pmsm_foc_sensorless_nucleo_G4_types_h_
#define pmsm_foc_sensorless_nucleo_G4_types_h_
#include "rtwtypes.h"
...
/* Custom Type definition for MATLABSystem: '<S208>/PWM Output' */
#include "stm_timer_ll.h"
#include "stm_timer_ll.h"
...
#ifndef typedef_stm32cube_blocks_PWMOutput_pmsm
#define typedef_stm32cube_blocks_PWMOutput_pmsm

typedef struct tag_C3ug75osl8w3UN1OXa3ipB stm32cube_blocks_PWMOutput_pmsm;

#endif                             /* typedef_stm32cube_blocks_PWMOutput_pmsm */
...
#ifndef typedef_stm32cube_blocks_AnalogInput_pm
#define typedef_stm32cube_blocks_AnalogInput_pm

typedef struct tag_ryp2yWF35eJG09Km2BkoGG stm32cube_blocks_AnalogInput_pm;

#endif                             /* typedef_stm32cube_blocks_AnalogInput_pm */
...
#ifndef typedef_stm32cube_blocks_UARTWrite_pmsm
#define typedef_stm32cube_blocks_UARTWrite_pmsm

typedef struct tag_K5QCAuLh2FF8FsZmLWzJxB stm32cube_blocks_UARTWrite_pmsm;

#endif                             /* typedef_stm32cube_blocks_UARTWrite_pmsm */

/* Parameters (default storage) */
typedef struct Parameters_pmsm_foc_sensorless__ Parameters_pmsm_foc_sensorless_;

/* Forward declaration for rtModel */
typedef struct tag_RTM_pmsm_foc_sensorless_nuc RT_MODEL_pmsm_foc_sensorless_nu;

#endif                              /* pmsm_foc_sensorless_nucleo_G4_types_h_ */
