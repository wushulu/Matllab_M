...
## 
## Makefile     : gc01.mk
## Generated on : Mon Sep 22 15:06:44 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/gc01.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/gc01.elf
...
SRCS = $(START_DIR)/gc01_ert_rtw/gc01.c
...
%.o : $(START_DIR)/gc01_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/gc01_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/gc01_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/gc01_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
gc01.o : $(START_DIR)/gc01_ert_rtw/gc01.c
	$(CC) $(CFLAGS) -o "$@" "$<"
