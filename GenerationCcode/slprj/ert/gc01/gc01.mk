###########################################################################
## Makefile generated for component 'gc01'. 
## 
## Makefile     : gc01.mk
## Generated on : Mon Sep 22 10:06:48 2025
## Final product: ./gc01_rtwlib.lib
...
START_DIR                 = D:/Work/Matlab/GenerationCcode
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = gc01_comp.rsp
CMD_FILE                  = gc01.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = gc01_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=gc01 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/gc01/gc01.c
...
%.o : $(START_DIR)/slprj/ert/gc01/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/gc01/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/gc01/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/gc01/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/gc01/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
gc01.o : $(START_DIR)/slprj/ert/gc01/gc01.c
	$(CC) $(CFLAGS) -o "$@" "$<"
