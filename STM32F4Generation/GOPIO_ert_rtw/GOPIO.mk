...
## 
## Makefile     : GOPIO.mk
## Generated on : Fri Sep 06 21:48:49 2024
...
COMPILER_COMMAND_FILE     = GOPIO_comp.rsp
CMD_FILE                  = GOPIO.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/GOPIO.elf
...
DEFINES_ = -DMW_ADC1_ENABLED=1 -DMW_ADC1_VAR=mw_adc1 -DMW_ADC1_INJ_IRQ_ENABLED=1 -DMW_TIM1_ENABLED=1 -DMW_USART2_ENABLED=1 -DMW_USART2_TXE_INTERRUPT_ENABLED=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DUSE_FULL_LL_DRIVER -DSTM32F401xE -DUSE_HAL_DRIVER -DMW_TIMEBASESOURCE=TIM5
...
CPP_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"D:\Work\Matlab\STM32F4Generation\GPIO\STM32CubeIDE\STM32F401RETX_FLASH.ld"
...
%.o : $(START_DIR)/GOPIO_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/GOPIO_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/GOPIO_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/GOPIO_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
GOPIO.o : $(START_DIR)/GOPIO_ert_rtw/GOPIO.c
	$(CC) $(CFLAGS) -o "$@" "$<"


GOPIO_data.o : $(START_DIR)/GOPIO_ert_rtw/GOPIO_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/GOPIO_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/GOPIO_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"
