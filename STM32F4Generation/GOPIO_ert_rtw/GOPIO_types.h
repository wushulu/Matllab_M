...
/* Custom Type definition for MATLABSystem: '<S16>/PWM Output' */
#include "stm_timer_ll.h"
#include "stm_timer_ll.h"
...
#ifndef typedef_stm32cube_blocks_UARTWrite_GO_T
#define typedef_stm32cube_blocks_UARTWrite_GO_T

typedef struct tag_K5QCAuLh2FF8FsZmLWzJxB stm32cube_blocks_UARTWrite_GO_T;

#endif                             /* typedef_stm32cube_blocks_UARTWrite_GO_T */
